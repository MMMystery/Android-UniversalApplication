...
import com.example.administrator.myuniversaltoolapplication.ui.activity.NewPostActivity;
...
public class ThreeFragment extends Fragment implements View.OnClickListener,FriendPostRecyclerAdapter.OnRecyclerViewItemClickListener, XRecyclerView.LoadingListener {

    private TextView topBar_tv_title;
    private Button topBar_btn_left,topBar_bt_right;

    private int pageNumber = 1;
    private static final int ITEM_NUM_PAGE = 10;
    ...
    private void initView(View view) {
        ...
        topBar_bt_right.setBackgroundResource(R.mipmap.bar_add);
